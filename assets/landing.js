...
import { mountPitchBackdrop } from './pitch-backdrop.js?v=63';
import { listMatches, seasonSummary } from './db.js?v=63';
import { byId, setText, toast, showOnly, figure, signed, plural } from './ui.js?v=63';
