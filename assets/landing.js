...
import { mountPitchBackdrop } from './pitch-backdrop.js?v=30';
import { listMatches, seasonSummary } from './db.js?v=30';
import { byId, setText, toast, showOnly, figure, signed, plural } from './ui.js?v=30';
