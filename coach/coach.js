...
import { renderStrip, timelineEnd, nowIndex } from '../assets/timeline.js?v=72';
import { renderShotMap, shotSummary } from '../assets/shot-map.js?v=72';
import { renderMatchVideo, teamMarks } from '../assets/match-video.js?v=72';
import {
...
} from '../assets/passing.js?v=72';
import { renderPassMap } from '../assets/pass-map.js?v=72';
import { seasonForms, formNote, MIN_FORM_POINTS } from '../assets/season.js?v=72';
...
import { mount as mountVideo, videoKind } from '../assets/video.js?v=72';
import {
