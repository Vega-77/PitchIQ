...
import { renderStrip, timelineEnd, nowIndex } from '../assets/timeline.js?v=100';
import { renderShotMap, shotSummary } from '../assets/shot-map.js?v=100';
...
} from '../assets/sample-report.js?v=100';
import {
    playersByTrack, passingNetwork, foldEdges, strongestLink, networkNote,
} from '../assets/passing.js?v=100';
import { renderPassMap } from '../assets/pass-map.js?v=100';
import { mergeHeatmaps, orientedCentroid } from '../assets/heatmap.js?v=100';
import {
    seasonForms, formNote, MIN_FORM_POINTS, MIN_POINT_MINUTES,
} from '../assets/season.js?v=100';
import { renderForms } from '../assets/form-chart.js?v=100';
import {
...
import { mountRail } from '../assets/rail.js?v=100';
import { mountPitchBackdrop, PITCH_LENGTH_M } from '../assets/pitch-backdrop.js?v=100';
import { mount as mountVideo, videoKind } from '../assets/video.js?v=100';
import {
