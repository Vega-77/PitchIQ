...
import { nowIndex } from '../assets/timeline.js?v=104';
import { renderShotMap, shotSummary } from '../assets/shot-map.js?v=104';
import { renderMatchVideo, teamMarks } from '../assets/match-video.js?v=104';
import {
    SAMPLE_NOTICE, isSample,
    samplePassEvents, samplePassMapping, sampleShapeGrids,
    sampleSubRoster, sampleSubEvents, sampleSubClock,
} from '../assets/sample-report.js?v=104';
import {
    playersByTrack, passingNetwork, foldEdges, strongestLink, networkNote,
} from '../assets/passing.js?v=104';
import { renderPassMap } from '../assets/pass-map.js?v=104';
import { mergeHeatmaps, orientedCentroid } from '../assets/heatmap.js?v=104';
import {
    seasonForms, formNote, MIN_FORM_POINTS, MIN_POINT_MINUTES,
} from '../assets/season.js?v=104';
import { renderForms } from '../assets/form-chart.js?v=104';
import {
...
import { CARD_COLOURS, describeEvent, timelineTone } from '../assets/events.js?v=104';
import { mountRail } from '../assets/rail.js?v=104';
import { mountPitchBackdrop, PITCH_LENGTH_M } from '../assets/pitch-backdrop.js?v=104';
import { videoKind } from '../assets/video.js?v=104';
import {
