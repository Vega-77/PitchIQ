...
import { renderStrip, timelineEnd, nowIndex } from '../assets/timeline.js?v=94';
import { renderShotMap, shotSummary } from '../assets/shot-map.js?v=94';
import { renderMatchVideo, teamMarks } from '../assets/match-video.js?v=94';
import {
...
} from '../assets/passing.js?v=94';
import { renderPassMap } from '../assets/pass-map.js?v=94';
import { mergeHeatmaps, orientedCentroid } from '../assets/heatmap.js?v=94';
import {
...
import { mountPitchBackdrop, PITCH_LENGTH_M } from '../assets/pitch-backdrop.js?v=94';
import { mount as mountVideo, videoKind } from '../assets/video.js?v=94';
import {
