...
import { onUser, signOut, configWarning } from '../assets/auth.js?v=31';
import { myReports, seasonTotals, cvPlayerConfidence } from '../assets/db.js?v=31';
import { CARD_COLOURS } from '../assets/events.js?v=31';
import { mountPitchBackdrop } from '../assets/pitch-backdrop.js?v=31';
import { renderHeatmap } from '../assets/heatmap.js?v=31';
...
import { samplePlayerReport, SAMPLE_NOTICE } from '../assets/sample-report.js?v=31';
import { videoTime } from '../assets/video.js?v=31';
import { renderMatchVideo } from '../assets/match-video.js?v=31';
import {
