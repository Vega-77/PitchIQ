...
import { onUser, signOut, configWarning } from '../assets/auth.js?v=63';
import { myReports, seasonTotals, cvPlayerConfidence } from '../assets/db.js?v=63';
import { CARD_COLOURS } from '../assets/events.js?v=63';
import { mountPitchBackdrop } from '../assets/pitch-backdrop.js?v=63';
import { renderHeatmap } from '../assets/heatmap.js?v=63';
...
import { renderMatchVideo } from '../assets/match-video.js?v=63';
import {
