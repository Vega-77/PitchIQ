...
import { Vector, Player } from './geometry.js?v=89';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=89';
import { PRESETS, fromMetres } from './presets.js?v=89';
