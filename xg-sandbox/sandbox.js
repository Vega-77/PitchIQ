...
import { Vector, Player } from './geometry.js?v=56';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=56';
import { PRESETS, fromMetres } from './presets.js?v=56';
