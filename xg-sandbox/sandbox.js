...
import { Vector, Player } from './geometry.js?v=66';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=66';
import { PRESETS, fromMetres } from './presets.js?v=66';
