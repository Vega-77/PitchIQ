...
import { Vector, Player } from './geometry.js?v=85';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=85';
import { PRESETS, fromMetres } from './presets.js?v=85';
