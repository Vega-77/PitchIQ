...
import { Vector, Player } from './geometry.js?v=42';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=42';
import { PRESETS, fromMetres } from './presets.js?v=42';
