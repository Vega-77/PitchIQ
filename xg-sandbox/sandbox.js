...
import { Vector, Player } from './geometry.js?v=63';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=63';
import { PRESETS, fromMetres } from './presets.js?v=63';
