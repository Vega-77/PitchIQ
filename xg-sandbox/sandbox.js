...
import { Vector, Player } from './geometry.js?v=30';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=30';
import { PRESETS, fromMetres } from './presets.js?v=30';
