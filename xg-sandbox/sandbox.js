...
import { Vector, Player } from './geometry.js?v=34';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=34';
import { PRESETS, fromMetres } from './presets.js?v=34';
