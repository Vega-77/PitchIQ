...
import { Vector, Player } from './geometry.js?v=79';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=79';
import { PRESETS, fromMetres } from './presets.js?v=79';
