...
import { Vector, Player } from './geometry.js?v=73';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=73';
import { PRESETS, fromMetres } from './presets.js?v=73';
