...
import { Vector, Player } from './geometry.js?v=58';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=58';
import { PRESETS, fromMetres } from './presets.js?v=58';
