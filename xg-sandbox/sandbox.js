...
import { Vector, Player } from './geometry.js?v=35';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=35';
import { PRESETS, fromMetres } from './presets.js?v=35';
