...
import { Vector, Player } from './geometry.js?v=98';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=98';
import { PRESETS, fromMetres } from './presets.js?v=98';
