...
import { Vector, Player } from './geometry.js?v=45';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=45';
import { PRESETS, fromMetres } from './presets.js?v=45';
