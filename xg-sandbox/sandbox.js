...
import { Vector, Player } from './geometry.js?v=103';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=103';
import { PRESETS, fromMetres } from './presets.js?v=103';
