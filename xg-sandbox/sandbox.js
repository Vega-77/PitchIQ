...
import { Vector, Player } from './geometry.js?v=86';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=86';
import { PRESETS, fromMetres } from './presets.js?v=86';
