...
import { Vector, Player } from './geometry.js?v=71';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=71';
import { PRESETS, fromMetres } from './presets.js?v=71';
