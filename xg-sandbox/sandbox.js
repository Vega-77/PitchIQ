...
import { Vector, Player } from './geometry.js?v=39';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=39';
import { PRESETS, fromMetres } from './presets.js?v=39';
