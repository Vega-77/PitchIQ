...
import { Vector, Player } from './geometry.js?v=31';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=31';
import { PRESETS, fromMetres } from './presets.js?v=31';
