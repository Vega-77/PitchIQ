...
import { Vector, Player } from './geometry.js?v=29';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=29';
import { PRESETS, fromMetres } from './presets.js?v=29';
