...
import { Vector, Player } from './geometry.js?v=46';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=46';
import { PRESETS, fromMetres } from './presets.js?v=46';
