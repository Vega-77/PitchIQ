...
import { Vector, Player } from './geometry.js?v=59';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=59';
import { PRESETS, fromMetres } from './presets.js?v=59';
