...
import { Vector, Player } from './geometry.js?v=95';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=95';
import { PRESETS, fromMetres } from './presets.js?v=95';
