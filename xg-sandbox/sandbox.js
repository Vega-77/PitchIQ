...
import { Vector, Player } from './geometry.js?v=43';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=43';
import { PRESETS, fromMetres } from './presets.js?v=43';
