...
import { Vector, Player } from './geometry.js?v=88';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=88';
import { PRESETS, fromMetres } from './presets.js?v=88';
