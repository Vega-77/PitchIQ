...
import { Vector, Player } from './geometry.js?v=92';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=92';
import { PRESETS, fromMetres } from './presets.js?v=92';
