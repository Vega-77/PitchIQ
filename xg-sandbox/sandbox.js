...
import { Vector, Player } from './geometry.js?v=28';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=28';
import { PRESETS, fromMetres } from './presets.js?v=28';
