...
import { Vector, Player } from './geometry.js?v=57';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=57';
import { PRESETS, fromMetres } from './presets.js?v=57';
