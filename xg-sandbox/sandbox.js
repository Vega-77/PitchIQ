...
import { Vector, Player } from './geometry.js?v=104';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=104';
import { PRESETS, fromMetres } from './presets.js?v=104';
