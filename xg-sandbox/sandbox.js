...
import { Vector, Player } from './geometry.js?v=38';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=38';
import { PRESETS, fromMetres } from './presets.js?v=38';
