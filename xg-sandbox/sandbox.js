...
import { Vector, Player } from './geometry.js?v=90';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=90';
import { PRESETS, fromMetres } from './presets.js?v=90';
