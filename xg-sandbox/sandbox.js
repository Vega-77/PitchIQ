...
import { Vector, Player } from './geometry.js?v=44';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=44';
import { PRESETS, fromMetres } from './presets.js?v=44';
