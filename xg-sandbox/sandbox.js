...
import { Vector, Player } from './geometry.js?v=87';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=87';
import { PRESETS, fromMetres } from './presets.js?v=87';
