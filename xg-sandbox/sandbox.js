...
import { Vector, Player } from './geometry.js?v=75';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=75';
import { PRESETS, fromMetres } from './presets.js?v=75';
