...
import { Vector, Player } from './geometry.js?v=81';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=81';
import { PRESETS, fromMetres } from './presets.js?v=81';
