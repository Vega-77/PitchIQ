...
import { Vector, Player } from './geometry.js?v=54';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=54';
import { PRESETS, fromMetres } from './presets.js?v=54';
