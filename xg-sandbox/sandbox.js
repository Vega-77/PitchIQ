...
import { Vector, Player } from './geometry.js?v=99';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=99';
import { PRESETS, fromMetres } from './presets.js?v=99';
