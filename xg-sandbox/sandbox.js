...
import { Vector, Player } from './geometry.js?v=60';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=60';
import { PRESETS, fromMetres } from './presets.js?v=60';
