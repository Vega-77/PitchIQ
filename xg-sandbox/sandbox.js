...
import { Vector, Player } from './geometry.js?v=82';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=82';
import { PRESETS, fromMetres } from './presets.js?v=82';
