...
import { Vector, Player } from './geometry.js?v=69';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=69';
import { PRESETS, fromMetres } from './presets.js?v=69';
