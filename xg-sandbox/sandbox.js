...
import { Vector, Player } from './geometry.js?v=48';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=48';
import { PRESETS, fromMetres } from './presets.js?v=48';
