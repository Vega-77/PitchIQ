...
import { Vector, Player } from './geometry.js?v=64';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=64';
import { PRESETS, fromMetres } from './presets.js?v=64';
