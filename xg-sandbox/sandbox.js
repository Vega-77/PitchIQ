...
import { Vector, Player } from './geometry.js?v=96';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=96';
import { PRESETS, fromMetres } from './presets.js?v=96';
