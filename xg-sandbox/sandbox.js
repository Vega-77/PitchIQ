...
import { Vector, Player } from './geometry.js?v=40';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=40';
import { PRESETS, fromMetres } from './presets.js?v=40';
