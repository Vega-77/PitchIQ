...
import { Vector, Player } from './geometry.js?v=41';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=41';
import { PRESETS, fromMetres } from './presets.js?v=41';
