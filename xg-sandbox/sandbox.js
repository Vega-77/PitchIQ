...
import { Vector, Player } from './geometry.js?v=65';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=65';
import { PRESETS, fromMetres } from './presets.js?v=65';
