...
import { Vector, Player } from './geometry.js?v=94';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=94';
import { PRESETS, fromMetres } from './presets.js?v=94';
