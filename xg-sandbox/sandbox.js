...
import { Vector, Player } from './geometry.js?v=105';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=105';
import { PRESETS, fromMetres } from './presets.js?v=105';
