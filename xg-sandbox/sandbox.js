...
import { Vector, Player } from './geometry.js?v=70';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=70';
import { PRESETS, fromMetres } from './presets.js?v=70';
