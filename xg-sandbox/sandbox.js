...
import { Vector, Player } from './geometry.js?v=53';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=53';
import { PRESETS, fromMetres } from './presets.js?v=53';
