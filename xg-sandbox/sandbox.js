...
import { Vector, Player } from './geometry.js?v=32';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=32';
import { PRESETS, fromMetres } from './presets.js?v=32';
