...
import { Vector, Player } from './geometry.js?v=50';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=50';
import { PRESETS, fromMetres } from './presets.js?v=50';
