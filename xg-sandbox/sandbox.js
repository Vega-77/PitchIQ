...
import { Vector, Player } from './geometry.js?v=37';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=37';
import { PRESETS, fromMetres } from './presets.js?v=37';
