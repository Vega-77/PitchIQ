...
import { Vector, Player } from './geometry.js?v=78';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=78';
import { PRESETS, fromMetres } from './presets.js?v=78';
