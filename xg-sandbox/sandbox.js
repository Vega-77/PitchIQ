...
import { Vector, Player } from './geometry.js?v=36';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=36';
import { PRESETS, fromMetres } from './presets.js?v=36';
