...
import { Vector, Player } from './geometry.js?v=106';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=106';
import { PRESETS, fromMetres } from './presets.js?v=106';
