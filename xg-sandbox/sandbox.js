...
import { Vector, Player } from './geometry.js?v=33';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=33';
import { PRESETS, fromMetres } from './presets.js?v=33';
