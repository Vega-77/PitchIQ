...
import { Vector, Player } from './geometry.js?v=83';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=83';
import { PRESETS, fromMetres } from './presets.js?v=83';
