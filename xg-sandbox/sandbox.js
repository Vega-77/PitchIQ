...
import { Vector, Player } from './geometry.js?v=84';
import { predictXg, buildFeatures, FEATURE_ORDER } from './xg-model.js?v=84';
import { PRESETS, fromMetres } from './presets.js?v=84';
